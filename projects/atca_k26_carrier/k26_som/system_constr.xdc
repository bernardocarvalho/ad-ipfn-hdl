...
set_property LOC [get_package_pins -filter {PIN_FUNC =~  *L3P_*_65}] [get_ports  {adc_sdo_cha_p[0]}]; #15A
set_property LOC [get_package_pins -filter {PIN_FUNC =~  *L1P_*_65}] [get_ports  {adc_sdo_chb_p[0]}]; #15B
set_property LOC [get_package_pins -filter {PIN_FUNC =~ *L17P_*_65}] [get_ports  {adc_sdo_cha_p[1]}]; #16A
set_property LOC [get_package_pins -filter {PIN_FUNC =~  *L2P_*_65}] [get_ports  {adc_sdo_chb_p[1]}]; #16B

set_property LOC [get_package_pins -filter {PIN_FUNC =~ *L22P_*_65}] [get_ports  {adc_sdo_cha_p[2]}]; #13A
set_property LOC [get_package_pins -filter {PIN_FUNC =~ *L23P_*_65}] [get_ports  {adc_sdo_chb_p[2]}]; #13B
set_property LOC [get_package_pins -filter {PIN_FUNC =~  *L5P_*_65}] [get_ports  {adc_sdo_cha_p[3]}]; #14A
set_property LOC [get_package_pins -filter {PIN_FUNC =~ *L16P_*_65}] [get_ports  {adc_sdo_chb_p[3]}]; #14B
...
set_property LOC [get_package_pins -filter {PIN_FUNC =~  *L4P_*_43}] [get_ports adc_chop]
